...
public static class DbInitializer
{
    public static void Initialize(toshokanContext context)
    {
        ...
        {
            new Book { Id = 1, Title = "The Lord of the Rings: The Fellowship of the Ring", Author = "J. R. R. Tolkien", Genre = "Fantasy", PublishedDate = DateTime.Parse("2023-01-01"), ImgURL = "https://1.bp.blogspot.com/-3Qr51FbCt7A/UP-ccYH1e0I/AAAAAAAAA2w/2aM1a9ZcBnk/s1600/the-lord-of-the-rings-fellowship-of-the-rings_1.jpg", RentCost = 5.99m },
            new Book { Id = 2, Title = "The Alchemist", Author = "Paulo Coelho", Genre = "Fantasy", PublishedDate = DateTime.Parse("2022-12-01"), ImgURL = "https://dailytimes.com.pk/assets/uploads/2021/07/06/the-alchemist-a-graphic-novel-1017x1536.jpg", RentCost = 4.99m },
            new Book { Id = 3, Title = "To Kill a Mockingbird", Author = "Harper Lee", Genre = "Fiction", PublishedDate = DateTime.Parse("2024-01-01"), ImgURL = "https://cdn2.penguin.com.au/covers/original/9781784752637.jpg", RentCost = 6.99m },
            new Book { Id = 4, Title = "The Hitchhiker's Guide to the Galaxy", Author = "Douglas Adams", Genre = "Science Fiction", PublishedDate = DateTime.Parse("2023-02-01"), ImgURL = "https://4.bp.blogspot.com/_KFxmlXHAk1A/TT3xWKVzB9I/AAAAAAAACTE/NE4KyvH94ys/s1600/hitchhikers_guide_to_the_galaxy_v1.jpg", RentCost = 5.49m },
            new Book { Id = 5, Title = "The Catcher in the Rye", Author = "J. D. Salinger", Genre = "Coming-of-Age", PublishedDate = DateTime.Parse("2024-03-01"), ImgURL = "https://i1.wp.com/bookstoker.com/wp-content/uploads/2019/03/The-Catcher-in-the-Rye-by-J.D.-Salinger.jpeg?fit=1089,1600&ssl=1", RentCost = 4.99m },
            new Book { Id = 6, Title = "The Great Gatsby", Author = "F. Scott Fitzgerald", Genre = "Fiction", PublishedDate = DateTime.Parse("2023-04-01"), ImgURL = "https://image.tmdb.org/t/p/original/ddzcKLZsz1Z3eGvSTrFYxFfCiJq.jpg", RentCost = 5.99m },
            new Book { Id = 7, Title = "Pride and Prejudice", Author = "Jane Austen", Genre = "Romance", PublishedDate = DateTime.Parse("2022-11-01"), ImgURL = "https://image.tmdb.org/t/p/original/vAxWpk857xbpaeoSvkRsfMbokPl.jpg", RentCost = 4.49m },
            new Book { Id = 8, Title = "Animal Farm", Author = "George Orwell", Genre = "Allegory", PublishedDate = DateTime.Parse("2024-02-01"), ImgURL = "https://upload.wikimedia.org/wikipedia/commons/f/fb/Animal_Farm_-_1st_edition.jpg", RentCost = 6.49m },
            new Book { Id = 9, Title = "The Book Thief", Author = "Markus Zusak", Genre = "Historical Fiction", PublishedDate = DateTime.Parse("2023-03-01"), ImgURL = "https://lumiere-a.akamaihd.net/v1/images/image_7324f2be.jpeg?region=0,0,1400,2100", RentCost = 5.99m },
            new Book { Id = 10, Title = "One Hundred Years of Solitude", Author = "Gabriel García Márquez", Genre = "Magical Realism", PublishedDate = DateTime.Parse("2022-10-01"), ImgURL = "https://interactive.wttw.com/sites/default/files/one-hundred-years-of-solitude@2x.jpg", RentCost = 6.99m },
        ...
        var members = new List<Member>()
        {
            ...
            new Member { FirstName = "Duc", LastName = "Tin", Address = "182 Main St", PhoneNumber = "091-683-2948", Email = "ductin2003@mail.net", MembershipDate = DateTime.Now.AddMonths(-7),Username = "tin", Password ="1234"},
        };
        ...
        var librarians = new List<Librarian>()
        {
            ...
            new Librarian { FirstName = "Duc", LastName = "Tin", PhoneNumber = "206-155-1234", Email = "dtadmin@library.com", EmploymentDate = DateTime.Now.AddYears(-2), Username = "admin", Password ="123" }, 
        };
