...
public static class DbInitializer
{
    public static void Initialize(toshokanContext context)
    {
        ...
        {
            new Book { Id = 1, Title = "The Lord of the Rings: The Fellowship of the Ring", Author = "J. R. R. Tolkien", Genre = "Fantasy", CopiesAvailable = 10, PublishedDate = DateTime.Parse("2023-01-01") },
            new Book { Id = 2, Title = "The Alchemist", Author = "Paulo Coelho", Genre = "Fantasy", CopiesAvailable = 5, PublishedDate = DateTime.Parse("2022-12-01") },
            new Book { Id = 3, Title = "To Kill a Mockingbird", Author = "Harper Lee", Genre = "Fiction", CopiesAvailable = 8, PublishedDate = DateTime.Parse("2024-01-01") },
            new Book { Id = 4, Title = "The Hitchhiker's Guide to the Galaxy", Author = "Douglas Adams", Genre = "Science Fiction", CopiesAvailable = 3, PublishedDate = DateTime.Parse("2023-02-01") },
            new Book { Id = 5, Title = "The Catcher in the Rye", Author = "J. D. Salinger", Genre = "Coming-of-Age", CopiesAvailable = 7, PublishedDate = DateTime.Parse("2024-03-01") },
            new Book { Id = 6, Title = "The Great Gatsby", Author = "F. Scott Fitzgerald", Genre = "Fiction", CopiesAvailable = 2, PublishedDate = DateTime.Parse("2023-04-01") },
            new Book { Id = 7, Title = "Pride and Prejudice", Author = "Jane Austen", Genre = "Romance", CopiesAvailable = 9, PublishedDate = DateTime.Parse("2022-11-01") },
            new Book { Id = 8, Title = "Animal Farm", Author = "George Orwell", Genre = "Allegory", CopiesAvailable = 4, PublishedDate = DateTime.Parse("2024-02-01") },
            new Book { Id = 9, Title = "The Book Thief", Author = "Markus Zusak", Genre = "Historical Fiction", CopiesAvailable = 6, PublishedDate = DateTime.Parse("2023-03-01") },
            new Book { Id = 10, Title = "One Hundred Years of Solitude", Author = "Gabriel García Márquez", Genre = "Magical Realism", CopiesAvailable = 1, PublishedDate = DateTime.Parse("2022-10-01") },
        };
        ...
        var loans = new List<Loan>()
        {
            ...
            new Loan { LoanDate = DateTime.Now.AddDays(-5), Returned = false, Book = context.Book.FirstOrDefault(b => b.Id == 6), Member = context.Member.FirstOrDefault(m => m.MemberID == 1) }, // Same member borrowing another book
        ...
        var reservations = new List<Reservation>()
        {
            ...
            new Reservation { ReservationDate = DateTime.Now, ExpirationDate = DateTime.Now.AddDays(10), Status = "Pending", Book = context.Book.FirstOrDefault(b => b.Id == 2), Member = context.Member.FirstOrDefault(m => m.MemberID == 1) }, // Same member reserving another book
            new Reservation { ReservationDate = DateTime.Now.AddDays(-10), ExpirationDate = DateTime.Now.AddDays(5), Status = "Approved", Book = context.Book.FirstOrDefault(b => b.Id == 4), Member = context.Member.FirstOrDefault(m => m.MemberID == 2) }, // Same member reserving another book
            new Reservation { ReservationDate = DateTime.Now.AddMonths(-2), ExpirationDate = DateTime.Now.AddDays(14), Status = "Pending", Book = context.Book.FirstOrDefault(b => b.Id == 6), Member = context.Member.FirstOrDefault(m => m.MemberID == 4) }, // Same member reserving another book
            new Reservation { ReservationDate = DateTime.Now.AddDays(-4), ExpirationDate = DateTime.Now.AddMonths(2), Status = "Pending", Book = context.Book.FirstOrDefault(b => b.Id == 8), Member = context.Member.FirstOrDefault(m => m.MemberID == 3) }, // Same member reserving another book
            new Reservation { ReservationDate = DateTime.Now.AddMonths(-2), ExpirationDate = DateTime.Now.AddMonths(-1), Status = "Expired", Book = context.Book.FirstOrDefault(b => b.Id == 10), Member = context.Member.FirstOrDefault(m => m.MemberID == 5) }, // Same member reserving another book
        };
